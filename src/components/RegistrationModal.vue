...
.reg-qty-btn:hover:not(:disabled) { border-color: #C84C3D; color: #C84C3D; }
.reg-qty-btn.primary {
  background: #C84C3D; border-color: #C84C3D; color: white;
}
...
.reg-total {
  display: flex; justify-content: space-between; align-items: center;
  padding: 16px 20px;
  background: rgba(200, 76, 61, 0.10);
  border-radius: 14px;
  margin-bottom: 18px;
}
.reg-total-lbl { font-size: 15px; font-weight: 600; color: var(--text); }
.reg-total-val { font-size: 22px; font-weight: 800; color: #C84C3D; }
...
.reg-cta {
  ...
  font-weight: 700;
  cursor: pointer;
  box-shadow: 0 8px 24px rgba(200,76,61,0.35);
  transition: transform 0.2s var(--ease), box-shadow 0.2s;
}
.reg-cta:hover:not(:disabled) { transform: translateY(-1px); box-shadow: 0 12px 30px rgba(200,76,61,0.45); }
...
.reg-field input:focus {
  border-color: #C84C3D;
  box-shadow: 0 0 0 3px rgba(200,76,61,0.15);
}
...
.reg-success-circle {
  ...
  display: flex; align-items: center; justify-content: center;
  color: white;
  box-shadow: 0 12px 32px rgba(200,76,61,0.45);
...
.reg-success-meta {
  background: rgba(200,76,61,0.08);
  border: 1px solid rgba(200,76,61,0.2);
  border-radius: 14px;
  padding: 14px 18px;
  margin-bottom: 22px;
  text-align: left;
